...
class Thread {
  ...
  public:
    ...
    int getWaiting_tick(){ return waiting_tick; }
    void setWaiting_tick(int value){ waiting_tick = value; }
    int getT(){ return T; }
    void setT(int value){ T = value; }
    double gett(){ return t; }
    void sett(double value){ t = value; }
    int getenter_running_tick(){ return enter_running_tick; }
    void setenter_running_tick(int value){ enter_running_tick = value; }
  ...
  private:
	...
	int   ID;
    int priority;
    int waiting_tick; // Waiting tick for aging
    int T; // CPU burst time
    double t; // Approximate waiting time
    int enter_running_tick;
